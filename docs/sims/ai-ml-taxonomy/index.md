...
```html
<iframe src="https://your-site.github.io/sims/ai-ml-taxonomy/main.html"
        width="100%"
        height="600px"
...
- [Neural Networks and Deep Learning](#) - Detailed exploration of the inner circle
- [Machine Learning Algorithms](#) - Comprehensive guide to ML approaches in healthcare
- [Clinical Decision Support Systems](#) - AI applications in healthcare
- [Medical Imaging and Computer Vision](#) - DL applications in radiology and pathology
- [Natural Language Processing in Healthcare](#) - Processing clinical notes and medical literature
- [Predictive Analytics for Patient Outcomes](#) - ML-driven risk assessment and forecasting
