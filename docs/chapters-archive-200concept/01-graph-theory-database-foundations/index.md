...
Type: graph-model
**sim-id:** basic-healthcare-graph-model-diagram<br/>
...
Type: diagram
**sim-id:** directed-acyclic-graph-care-pathway<br/>
**Library:** p5.js<br/>
**Status:** Specified
use the hc-graph-generator skill to create a new MicroSim using the following requirements
...
Type: graph-model
**sim-id:** healthcare-labeled-property-graph-visualization<br/>
**Library:** vis-network<br/>
**Status:** Specified
...
Type: workflow
**sim-id:** healthcare-data-model-implementation-workflow<br/>
**Library:** Mermaid<br/>
**Status:** Specified
