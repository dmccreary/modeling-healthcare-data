...
| 3 | MicroSims | 9 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 12 / 12 | Recommended | Chapters with a quiz.md (51 questions total) |
...
| 9 | Words | 145,703 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 6 | 6 | H4 headers starting with '#### Diagram:' |
| Equations | 49 | 40 | LaTeX expressions (inline and display) |
| Total Words | 145,703 | 113,685 | Words in markdown files |
| Links | 327 | 183 | Hyperlinks in markdown format |
| Equivalent Pages | 588 | 460 | Estimated pages (250 words/page + visuals) |
