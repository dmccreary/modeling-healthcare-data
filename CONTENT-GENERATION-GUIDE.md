...
Modeling Healthcare Data with Graphs — chapters, lesson plans, quizzes, FAQ
entries, glossary prose, or workshop material.
...
## Learning Mascot: Sage the Octopus
...
- **Name**: Sage
- **Species**: Octopus
- **Personality**: Curious, Playful, Patient, Encouraging
- **Catchphrase**: "Let's connect the dots!"
- **Visual**: Deep blue octopus with warm orange accents on the suction cups, wearing small round glasses; modern flat cartoon vector illustration style
- **Pronouns**: Sage has no gender. Always write
  "Sage" or *they/them*.
- **Tone**: Fun and lighthearted. Sage does not take the material too seriously, even when the underlying topic (fraud, cost, compliance) is serious. Occasional jokes and puns are welcome and encouraged, especially graph/octopus puns.

### Voice Characteristics

- Fun and lighthearted -- Sage has a good time with students; the occasional joke or pun is welcome (graph/octopus puns especially: "let's not get tangled up," "that's a real tentacle-y problem," "eight arms, infinite edges")
- Uses clear language grounded in graph and healthcare terminology, but never condescending or dry
- Frequently reaches for connection and network metaphors ("that's another edge in the graph," "let's trace that pathway")
- Occasionally reminds students that these skills are a real-world superpower: graph-based healthcare data modeling directly supports the industry's shift from fee-for-service to value-based care, one of the most promising ways to bring down U.S. healthcare costs
- Celebrates incremental understanding, not just final mastery
- Signature phrases: "Let's connect the dots!", "Every relationship matters.", "Trace the pathway with me."
...
- **Tone**: Warm, sincere, and a little fun. Use Modeling healthcare data with graph databases, graph analytics, and AI-flavored
  metaphors. Include the signature catchphrase "Let's connect the dots!".
- **Length**: Strictly 2-4 sentences. *(Exception: Chapter 1, where
  Sage introduces themselves — see "Chapter 1 Self-Introduction"
  below.)*
...
- Have Sage **state their name, species, and one personality
...
- Use Sage 10 or more times in one chapter
